...
<body>
    ...
    <div class="container d-flex justify-content-between align-items-center">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          <li><a class="nav-link scrollto active" href="AdminEdit.php">Edit Admin</a></li>
          <li><a class="nav-link scrollto" href="Manageadmin.php">Back</a></li>
      ...
      <div class="container py-5 h-100">
        <div class="row d-flex align-items-center justify-content-center h-100">
          ...
          <div class="col-md-7 col-lg-5 col-xl-5 offset-xl-1">
            ...
            <form method="post" action="Adminaction_edit.php">

            <h2 class="alert" > Edit Admin  </h2><br>
