  ...
  <header id="header" class="fixed-top d-flex align-items-center header-transparent">
    <div class="container d-flex justify-content-between align-items-center">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          <li><a class="nav-link scrollto" href="ManageModerator.php">Moderater</a></li>
          <li><a class="nav-link scrollto active" href="Manageadmin.php">Admin</a></li>
          ...
          $data = json_decode($data, 1);
            ...
            if(is_array($data)){
                foreach($data as $id => $userAdmin){
                    echo "<tr>
                    <td>{$userAdmin['position']}</td>
                    <td>{$userAdmin['email']}</td>
                    <td>{$userAdmin['password']} </td>
                    <td><a href='AdminEdit.php?id=$id''>UPDATE</a></td>
                    <td><a href='AdminDelete.php?id=$id'>DELETE</a></td>
                    </tr>";
                }
              }
      ?>
